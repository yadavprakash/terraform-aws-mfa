...
```hcl
module "mfa" {
  source      = "git::https://github.com/yadavprakash/terraform-aws-mfa.git?ref=v1.0.0"
  name        = "mfa1"
  environment = "test"
  users       = []
  groups      = []
...
# Examples
For detailed examples on how to use this module, please refer to the '[example](https://github.com/yadavprakash/terraform-aws-mfa/tree/master/example)' directory within this repository.
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/yadavprakash/terraform-aws-mfa/blob/master/LICENSE) file for details.
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/yadavprakash/terraform-aws-mfa"` | no |
